    ...
    <div class="container" style="margin-top: 80px">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Partes y Soportes</li>
            </ol>
        </nav>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-7">
                ...
                @else
                    ...
                    <a href="./../public/shop" class="btn btn-dark">Continue en la tienda</a>
                @endif
        ...
        <div class="row justify-content-center">
            <div class="col-lg-7">
                ...
                @if($cartCollection->count() > 0)
                    <h4>{{ $cartCollection->count() }} Producto(s) en el carrito</h4><br>
                @else
                ...
                @foreach($cartCollection as $item)
                    <div class="row">
                        <div class="col-lg-3">
                            <img src="/images/{{ $item->imagen }}" class="img-thumbnail" width="200" height="200">
                        </div>
                        <div class="col-lg-5">
                            <p>
                                <b><a href="/shop/{{ $item->slug }}">{{ $item->name }}</a></b><br>
                                <b>Precio: </b>${{ $item->precio }}<br>
                                <b>Subtotal: </b>${{ $item->pr * $item->quantity }}<br>
                            </p>
                        </div>
                        <div class="col-lg-4">
                            <div class="row">
                                <form action="{{ route('cart.update') }}" method="POST">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input type="number" class="form-control form-control-sm" value="{{ $item->quantity }}"
                                               id="quantity" name="quantity" style="width: 70px; margin-right: 10px;">
                                        <button class="btn btn-secondary btn-sm" style="margin-right: 25px;"><i class="
...
<br><a href="{{ url('/shop') }}" class="btn btn-primary">Continuar comprando</a>
<a href="{{ url('/checkout') }}" class="btn btn-success">Ir al pago</a>
</div>
@endif
</div>
<br><br>
