              ...
              <form role="form text-left" 
                ...
                <div class="form-check form-check-info text-left">
                  ...
                  <label    class="form-check-label" 
                            for="flexCheckDefault">Estoy de acuerdo con los 
                            <a href="javascript:;" 
                            class="text-dark font-weight-bolder">Terminos y Condiciones</a> de la pagina.
                  </label>
                  @error('agreement')
                
                    <p class="text-danger text-xs mt-2">First, estoy de acuerdo con los terminos y Condiciones de la pagina</p>
                ...
                <div class="text-center">
                  <button   type="submit" 
                            class="btn btn-primary w-100 my-4 mb-2">Registrate</button>
                </div>

                <div class="text-center">
                <p  class="text-sm mt-4 mb-0">Ya tienes una cuenta? 
                    <a href="login" 
                    class="text-blue font-weight-bolder">Inicia Sesion</a></p>
                </div>  
            </form>
            </div>
          </div>
